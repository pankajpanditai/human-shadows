      ...
      phases: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "<em>Odd. Sarn. Little Fen.</em> Three names, the doubled stroke, and beside each the sign for sound stone. Men who had spent themselves at ruinous rate for a written-off man because <em>ours</em> outranked the book. Whatever was one day built, it would be built on that.",
            "<em>Jack.</em> The doubled stroke, cut deep, the slat almost splitting under it. And beside his name a mark Rik invented on the spot and would never need to invent again, a small open square: the hand that turns you at the door. First of that column. Likely last.",
            "<em>Marn</em>, and the sign for the well, and the sign for teaching. The old ones knew things the ladder had never priced — knots, tricks of the rope, the patience of benches — and any road east would need what benches knew.",
