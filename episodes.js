        ...
        },
        {
        ...
        },
         {
          ...
          paragraphs: [
            ...
            "The warden had come down from his post with his ledger-board tucked beneath one arm. He stood at the square's edge while the healer worked, old and heavy in his good coat, looking less like an official than a man who had brought writing to a place where writing could do nothing. He knew Tesk. The whole village knew Tesk. His household already stood on the board, his rise-address, his column standing, the tall-doored house behind the crowd waiting to receive whatever the road had returned. There was no name to ask for at the litter.",
            "The three carrying it were another matter. The warden's gaze passed over them once, professionally, and he said to Jack, because Jack was nearest and upright, \"Names and home rows after the healer.\"",
            "Jack nodded. The warden went with the litter when they lifted it again, not to help, because his hands were full of the board, but to see Tesk entered through the correct door.",
            "They carried him up the rise. There was nowhere else. His household stood there, the tall-doored house, the banner, the collared women who kept it, and the floor watched four of its own bear the litter up the slope into the converted row, watched the lantern over Tesk's door lit for him by a servant's hand, watched the door held, at the trained level, for a man carried through it at knee height. The rise received its own. The window came alight. From the square below it looked like any other lit window on the slope, and that, Rik thought, standing in the spore-fall with his son's paw now in his, was the most complete thing the ebb had said yet: from far enough away, from the book's distance, the light over a ruin and the light over a reward were the same entry.",
            "The three bearers would not go up the rise. They took Ruby's broth against the well, sitting close together now that the yokes were off, like men who had put a country between themselves and their last orders and had not yet understood that the last orders could travel. Rik crouched with them. Jack remained standing.",
            ...
            "\"He was ours.\"",
            "He was ours.",
            "Rik received the sentence like a killing stone receives what is brought to it, in silence, entirely. Every book he lived under priced loyalty as a discount you extracted from the loyal. Here was the un-entered opposite: loss taken on purpose, at ruinous rate, for nothing, for a man, because ours was a word that predated every ledger and would outlive them. The three spent rats against the well were the richest creatures Rik had met in the Matriarchy's whole territory, and did not know it, and were ashamed, he could see, that they had not managed to also save his legs.",
            "Beside him, Jack had gone still in a different way.",
            "His eyes were no longer on the bearers. They had moved past them, across the square to the warden's post, where the lamp had come on behind the board. Then to the lane up the rise. Then to the south road, empty again in the fungal glow.",
            "\"You left the retreat,\" Jack said.",
            "The eldest looked up. \"The retreat left him.\"",
            "\"That isn't what their book will say.\"",
            "No one answered.",
            "Jack looked at the youngest, at the shoulders still raw beneath the broth-steam, and something in his watch-face closed around a decision.",
            "\"Did anyone take your names after the river?\"",
            "\"No.\"",
            "\"Did anyone see you take him?\"",
            "\"Everyone was seeing something else.\"",
            "Jack nodded once. \"Then you don't sit at the well.\"",
            "The eldest frowned, too tired to follow.",
            "\"The warden asked for your names,\" Jack said. \"At the next waking, he'll ask again. After him, somebody with a seal. Get up.\"",
            "Ruby heard. Rik knew she heard because she turned at once to the two women returning with more broth and intercepted them halfway across the square, taking the pot herself, dismissing them with a word and no explanation. Then, to the few villagers still lingering, she said that the road-men had fever on them and needed sleep more than questions. The square accepted the practical sentence and thinned. Practical sentences were Ruby's borders; most people crossed them without noticing they had been redirected.",
            "Jack took the bearers by the back lane, away from the warden's post and the lit rise, toward the cohort row along the east wall. Rik followed with the broth. The three walked because Jack had told them to, which was the last reserve their bodies had left: obedience offered to the first voice that sounded as though it knew where the next floor was.",
            "The twelfth door stood open. Four bunks. Jack's, lived in badly. Three others made square, kept for men whose names the warden's board had never released because the rivers had sent back no word it could enter. Brye's spare bowstring still wound on its stick. Two coats on pegs, one patched at the elbow. A cup with a crack along its rim that no one had thrown away.",
            "The three bearers stopped at the threshold.",
            "Jack looked at the kept beds a long time. He had made them that morning, as he made them every morning, though no one had asked and the room itself had stopped pretending to expect anyone. Rik watched the expectation leave him without drama. Not die. Change use.",
            "\"They carried one of ours home,\" Jack said, to the empty bunks. \"Brye would call that rent.\"",
            "Then he stood aside.",
            "The three entered. Not by the book, which had stopped, but by the floor, which had not.",
            "Jack shut the door before anyone gave a name.",
            "Only then, in the small room under the three unstruck names, did the bearers tell them who they were.",
            "Odd, the eldest, broad through the shoulders even after the road had eaten him down.",
            "Sarn, who had walked beside the litter with one paw on it for four hundred miles and still kept that paw half-raised now, as if the missing edge remained beneath it.",
            "Little Fen, a season shy of full grown, who looked younger indoors than he had under the yoke and tried to apologize for finishing the broth too quickly.",
            "Jack repeated each name once and then said, \"Those stay in this room. Outside, you came through and kept walking.\"",
            "\"Where?\" Sarn asked.",
            "\"Somewhere the warden can't check before his next report.\"",
            "Odd studied him. \"And where do we sleep?\"",
            "Jack looked at the three beds again. \"Tonight, here. Tomorrow, we decide how far below a kept name a living man can fit.\"",
            "That night, after the village had settled and the bells had declared an hour the darkness already knew, Rik climbed the rise to begin paying the debt Tesk had entered in the square.",
            "The collared women admitted him. The older one held the door at the trained level. The younger was wringing out linen at a basin gone pink, and neither asked why he had come. Tesk lay beneath the banner in a bed built for a master, his eyes open, the room priced around him exactly as before, as if the lower half of the man had not been subtracted from it.",
            "Rik sat where a guest sat.",
            "For a while Tesk kept the cadence alive. The south, the crossing, the men who had held longer than anyone thought, the column that had almost turned the river. Almost was the trader's oldest cloth; Tesk could still make a whole market out of it. Rik let him. This was not yet the last conversation. This was only the first evening of the debt.",
            "When the women went to change the water, Rik leaned forward.",
            "\"They'll ask who carried you.\"",
            "Tesk's eyes moved to him, quick and clear.",
            "\"Yes,\" he said.",
            "\"Don't give them three names.\"",
            "The trough-side smile moved faintly under the ruin of his face. \"Three names? Brother, I couldn't give them three faces. I woke under different shoulders every time. One by the river. Two in the reeds. Someone else at a culvert. The road changed hands whenever I closed my eyes.\"",
            "\"The three who reached here—\"",
            "\"May not be the three who began.\" Tesk settled the story into place with the care of a merchant folding cloth along an old crease. \"Fever makes poor records.\"",
            "Rik held his gaze. \"Don't ask where they are.\"",
            "\"Wasn't going to.\" A pause, and then, quieter: \"Don't tell me.\"",
            "There it was again, the book read from further inside. Trust measured not by what a man was told but by what he agreed not to know.",
            "Rik stayed another hour and let the Garden stand between them, thin and green and impossible, while below the rise three men slept in beds the state believed empty.",
            "He walked home through the spore-fall with the three names repeating in him, not as a roster, not yet as a plan, but as weight: Odd. Sarn. Little Fen. Names worth more than the entire rise, and written nowhere.",
            "Someone should, he thought.",
            "And stood very still on his own threshold, in the dark of the year, listening to what he had just thought."
          ],
          visual: { img: "", grad: "linear-gradient(170deg, #182025 0%, #101619 48%, #07090a 100%)", tint: "rgba(135,190,170,.14)", glow: "#9bc9ba", fx: "dust" }
        },
        {
          id: "e7-6",
          tag: "SCENE 06 · THE SECOND BOOK",
          title: "First Entries",
          railLabel: "THE BOOK", railSub: "SCENE 06", railLen: 2,
          paragraphs: [
            { lead: true, text: "The warden came for the missing names at the next waking." },
            "He did not come accusingly. That would have been easier. He found Rik at the well with the household bucket and held the ledger-board under one arm, the practical nuisance of unfinished work on his face.",
            "\"The three from the south,\" he said. \"Names, home rows, column if they knew it.\"",
            "Rik had spent the dark preparing a lie and discovered, when the moment came, that the best lie was mostly an absence.",
            "\"They left before the waking bell.\"",
            "The warden's ears shifted. \"All three.\"",
            "\"They were afraid of being entered as deserters. One said they had somewhere else to reach. Wouldn't say where.\"",
            "\"You didn't ask?\"",
            "\"They carried Tesk four hundred miles,\" Rik said. \"I gave them broth. I thought questions could wait until they'd slept. They didn't sleep.\"",
            "The warden looked at him a moment, then toward the south road, then back to the board. Irritation, not suspicion. A clerk's dislike of a hole that had walked away before it could be given edges.",
            "\"Another hamlet?\"",
            "\"Maybe. They didn't say.\"",
            "That was the only invented possibility, and Rik let the warden supply it himself.",
            "The warden made a notation. Rik could not read the angular hand, but he knew the grain of official sentences by now, the way a quarryman knows stone by the sound of the first strike: three unidentified southern levy rats; accompanied registered return; departed before intake; destination unknown.",
            "The board remained honest. The warden remained outside the lie.",
            "Every second waking, the board traveled without moving. The warden copied its changes onto a narrow return-strip — arrivals, deaths, rooms released, household transfers, levy status — sealed it beneath the village mark, and gave it to the district courier on the west road. Small places reported themselves upward so the state would never need to descend merely to know them.",
            "On the second waking after Tesk came home, the return-strip carried two new lines.",
            "Tesk: returned from southern column. Incapacitated. Household resumed.",
            "Three unidentified levy escorts: departed before intake. Destination unknown.",
            "The courier tucked the strip into an iron-clasped satchel and rode west at the unhurried pace of information that knew every road would open for it.",
            "Rik watched from the market lane without appearing to watch. He did not know what the military book said beside Tesk's name. He had not stood at the river when the retreating clerk wrote it. But the three hidden men had told him the words, and the words had the hard finish of an entry already closed:",
            "Written off. Salvage nil.",
            "Somewhere west, before the next waking or the one after, two books would be laid open under the same lamp. One would say the man had ceased to be worth carrying. The other would say he had arrived home alive.",
            "The contradiction rode out of the village in a sealed satchel.",
            "The three bearers did not leave Jack's room.",
            "Ruby brought food at the slack hour in a covered basket and returned with the same basket apparently empty. Jack fetched water before the square filled and carried enough for four men, which no one remarked upon because Jack had lived alone so long that the village had stopped counting what entered his door. Rik visited after the sleep-bell, never by the same lane twice. Odd slept in Brye's bed. Sarn took the bunk beneath the cracked cup. Little Fen lay under the patched coat and woke at every footstep outside, one paw already reaching for a litter-pole that was no longer there.",
            "The warden never came to the twelfth door. The room still carried four official names, one present and three unresolved, and the board gave him no lawful reason to count its blankets. That was the shelter: not his sympathy, not his courage, not even his suspicion. His ignorance, kept clean.",
            "The names Odd, Sarn, and Little Fen entered no village board. They passed no well, no market, no shrine. They existed, officially, only as three figures seen once beneath road-filth and fever-light, already departing in the line the warden had sent west.",
            "Rik carried their true names home like coin.",
            ...
            "The book itself he had already made. That had been the strange labor, the crafting of a thing he had no word for owning. He could not buy a bound book: coin left ledgers, ledgers left questions, and a rat purchasing paper was an entry someone else would read. So he had made it the floor's way, out of the world's leavings: thin slats of seasoned wood, split fine and rubbed smooth, drilled at one corner and strung on a bowstring's worth of waxed cord — Jack's cord, as it happened, begged as scrap, so that the book's spine was already his friend's before his friend's name went into it. It looked, finished, like a tally-keeper's fan, like a child's clatter-toy, like nothing. It would burn in a breath if a breath was ever needed.",
            "And it was written in no script the Garden held.",
            "That had been the second labor, and the one that had taken him the season: the quarry's one lettered rat had sold him reading, years ago, for hoarded grain, but writing was the masters' craft, and the masters' scripts were the masters' — the angular hand he could not stop imagining his name in, the trade-crab he could spell out slowly, both of them languages that arrived with a state attached. So he had gone further down, to the oldest writing he owned, the writing that was already in his hands: quarry tally-marks, load-counts, the hauliers' signs scratched on gallery walls to warn the next shift — bad stone, wet seam, short props — a script with no words in it, only weights and warnings, and he had bent it, mark by private mark, into a thing that could hold names. A circle for the well. A doubled stroke for worth trusting. The old sign for sound stone — the one his father had taught him to cut, the one that meant build on this — set beside a name, meaning what it had always meant.",
            "No priest could read it. No quartermaster, no warden, no commander, no catechist. If the stone were ever lifted by other hands, they would find a child's toy scratched with hauliers' marks, and the entire manifest of everything Rik loved would look to the state's eyes like what the state had always seen when it looked at rats: noise, beneath transcription.",
            "He sat cross-legged on the floor of the second room, in the spore-glow seeping through the shutter, and made the first entries of the first accounting any rat he had ever known had kept for himself.",
            "Odd. Sarn. Little Fen. Three names, the doubled stroke, and beside each the sign for sound stone. Men who had spent themselves at ruinous rate for a written-off man because ours outranked the book. Whatever was one day built, it would be built on that.",
            "Jack. The doubled stroke, cut deep, the slat almost splitting under it. And beside his name a mark Rik invented on the spot and would never need to invent again, a small open square: the hand that turns you at the door. First of that column. Likely last.",
            "Marn, and the sign for the well, and the sign for teaching. The old ones knew things the ladder had never priced — knots, tricks of the rope, the patience of benches — and any road east would need what benches knew.",
            "Then the counts, in the honest old load-marks: the stash, coin by coin, entered true. The widows' hour at the well, eleven, rising. The rooms of the row, kept names, nine doors. The dry stores a household could spare against a season no one had named yet. And on the last slat, working slowly from the worn map spread beside him — the camel trader's map, edges smoothed by years of believing hands, the map that had already carried four souls out of one country — a copied fragment: not the north roads, which were spent, but the east ones. The caravan lines through the desert realm where every road had a price and therefore, unlike every other thing in the Garden, a rat with coin was a customer. The wetlands beyond, where the rivers ran under a sky that bowed to no king. And past the far edge of the fragment, off the map entire, in the place where maps keep their myths, he cut the oldest sign the quarries owned — the mark hauliers scratched at a gallery's mouth to say this one goes through — and beneath it, in his own new script, a word that was not a word, only a weight:",
            "Teeth.",
            "He did not write a plan, because there was no plan. There was a hollow in the floor, and a toy that was a ledger, and five names, and a direction. The exodus that would one day walk out of the gate that opened inward began its existence that night as four wooden slats under a mason's shortcut, years before anyone walked, the way every wall he had ever breached had begun as a seam: a hand-span of possibility, waiting for someone thin enough, low enough, patient enough to need it.",
            ...
            "Outside, the fungal night deepened over the village, over the square, over the lit window on the rise where a broken man lay awake with his intact eyes, over the twelfth room where three carriers slept in kept beds, and the record that continues continued now in two hands: the state's, immaculate, its contradiction already riding west — and beneath a floor-stone in the third lane, four wooden slats, five names, and a direction.",
          ...
          visual: { img: "", grad: "linear-gradient(170deg, #29241d 0%, #171410 48%, #090807 100%)", tint: "rgba(174,140,92,.14)", glow: "#c7aa7b", fx: "dust" }
        }
      ],
      end: {
