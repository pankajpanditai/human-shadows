...
- Hub card chm2 now carries art (images/episodes/SFTMPart2.jpg). New coming-soon card chm3 (PART III · NOT YET RECORDED) follows it: rescue, the workbench again, and the first hint of how Zev will reframe the island chain.
...
- Also fixed in Episode 05's broom argument (earlier commit d873fbc): Tesk's original "leave the cows in the ruin" plan silently contradicted Scene 05, where the cows arrive at the border with the group. Brye now rebuts the ruin plan on the group's own logic (a description doesn't age), forcing the fourth plan that actually plays out: escort the cows across the line as "protected" subjects, front-loading the doctrine phrase whose cold payoff lands at the crossing.
